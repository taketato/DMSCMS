...
const WholesalerInvPage = () => {
    ...
    const fetchInvinfo = () => {
        ...
        return fetch(`http://localhost:${PORT_NUM}/admin/wholesaler/inventory`, {
          method: 'POST',
          headers: {
    ...
    const updateInvinfo_receive = () => {
        ...
        return fetch(`http://localhost:${PORT_NUM}/admin/wholesaler/set_inventory`, {
            method: 'POST',
            headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
    ...
    const updateInvinfo_send = () => {
        ...
        return fetch(`http://localhost:${PORT_NUM}/admin/wholesaler/set_outbound`, {
            method: 'POST',
            headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
    ...
    return (
        <Container maxWidth="md">
            ...
            <Paper elevation={3} style={{ padding: '20px', marginTop: '30px' }}>
                ...
                {/* Link to Homepage */}
                <Box mt={4} mb={2}>
                  <Link to="/wholesaler/homepage" style={{ textDecoration: 'none' }}>
                      <Button variant="outlined" color="secondary">
                        Go to Wholesaler homepage
                      </Button>
                  </Link>
              </Box>
            </Paper>
...
export default WholesalerInvPage;
